...
- [[#configuration][Configuration]]
  - [[#port-number-and-domain-assignments----bisosbanna][Port Number and Domain Assignments -- bisos.banna]]
  - [[#development-port-numbers][Development Port Numbers]]
  - [[#production-here-documents][Production .here documents]]
  - [[#service-urls-configuration][Service URLs Configuration]]
  - [[#invokerperformer-abstraction][Invoker/Performer Abstraction]]
- [[#development-setup-and-usage][Development Setup and Usage]]
  - [[#csplayerperf----django-cs-player-performer][csPlayerPerf -- Django CS Player Performer]]
  - [[#cslineinvoker-----react-app-----command-line-constructor-and-executer][csLineInvoker --  React App --  Command-Line Constructor and Executer]]
  - [[#csplayer----gatsby-react-app----cs-player-wrapper][csPlayer -- Gatsby-React App -- CS Player Wrapper]]
...
Port numbers and domains for this application are assigned through
bisos.banna (BISOS Assigned Names  and Numbers Authority).
